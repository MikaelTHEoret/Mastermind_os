...
const getEnvVars = (): EnvVars & { ollamaHost: string; ollamaModel: string } => {
  ...
  const ollamaHost = getEnvVar('VITE_OLLAMA_HOST', 'http://localhost:11434');
  const ollamaModel = getEnvVar('VITE_OLLAMA_MODEL', 'llama2');
...
const defaultConfig: Config = {
  ...
  ai: {
    ...
    ollama: {
      host: envConfig.ollamaHost,
      port: 11434, // Port is included in VITE_OLLAMA_HOST
